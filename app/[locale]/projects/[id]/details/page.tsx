            ...
            <div className="bg-white rounded-[10px] p-4 sm:p-6 border-2 border-[#20284D]">
              ...
              <div className="flex justify-between items-center flex-wrap gap-4">
                <div className="text-center flex-1 min-w-[100px]">
                  <span className="block text-[24px] sm:text-[28px] md:text-[30px] font-bold text-[#20284D] leading-tight">8 دقائق</span>
                  <span className="text-[14px] sm:text-[16px] font-bold text-[#20284D]">برج الملك</span>
                </div>
                <div className="text-center flex-1 min-w-[100px]">
                  <span className="block text-[24px] sm:text-[28px] md:text-[30px] font-bold text-[#20284D] leading-tight">16 دقيقة</span>
                  <span className="text-[14px] sm:text-[16px] font-bold text-[#20284D]">حديقة الملك</span>
                </div>
                <div className="text-center flex-1 min-w-[100px]">
                  <span className="block text-[24px] sm:text-[28px] md:text-[30px] font-bold text-[#20284D] leading-tight">10 دقائق</span>
                  <span className="text-[14px] sm:text-[16px] font-bold text-[#20284D]">محطة القطار</span>
                </div>
              </div>
              ...
              <div className="text-center">
                <p className="text-[24px] sm:text-[28px] md:text-[30px] font-bold text-[#20284D] leading-tight">السعر : 550 ريال</p>
              </div>
            </div>

            <div className="bg-white rounded-[10px] p-4 sm:p-6 border-2 border-[#20284D] h-auto sm:h-[93px] flex justify-between items-center">
              <Image 
              ...
              />
              <span className="text-[14px] sm:text-[16px] font-bold text-[#20284D] leading-normal sm:leading-[30px] text-center">
          ...
          <div className="relative mb-6">
            <div className="relative px-4 sm:px-[50px]">
              ...
              <button 
                ...
                className="absolute left-0 top-1/2 transform -translate-y-1/2 w-[40px] h-[40px] sm:w-[50px] sm:h-[50px] bg-white/80 hover:bg-white border border-[#20284D] rounded-full flex items-center justify-center transition-colors"
              ...
              <button 
                ...
                className="absolute right-0 top-1/2 transform -translate-y-1/2 w-[40px] h-[40px] sm:w-[50px] sm:h-[50px] bg-white/80 hover:bg-white border border-[#20284D] rounded-full flex items-center justify-center transition-colors"
