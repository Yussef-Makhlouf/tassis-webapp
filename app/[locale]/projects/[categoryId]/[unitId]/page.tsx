...
//       try {
//         const response = await fetch(`https://tasis-al-bina.onrender.com/unit/getunit/${params.unitId}`);
...
//         <div className="animate-spin rounded-full h-16 w-16 border-t-4 border-[#AA9554] border-solid"></div>
...
//   const features = [
//     { icon: "/project/image-4.png", label: "الحارس", value: unit.guard.toString() },
//     { icon: "/project/image-3.png", label: "غرف الخادمة", value: unit.maidRoom.toString() },
//     { icon: "/project/image-1.png", label: "الحمامات", value: unit.bathrooms.toString() },
//     { icon: "/project/image-9.png", label: "الغرف", value: unit.rooms.toString() },
//     { icon: "/project/image.png", label: "المساحة", value: `${unit.area} m` },
//     { icon: "/project/image-5.png", label: "كاميرات مراقبة", value: unit.cameras.toString() },
//     { icon: "/project/image-8.png", label: "مصعد خاص", value: unit.elevators.toString() },
//     { icon: "/project/image-7.png", label: "مواقف السيارات", value: unit.parking.toString() },
//     { icon: "/project/image-6.png", label: "خزانات المياه", value: unit.waterTank.toString() },
//     { icon: "/project/image-2.png", label: "الصاله", value: unit.livingrooms.toString() },
//   ];
...
//           <h1 className="text-[28px] sm:text-[32px] md:text-[40px] font-bold text-[#20284] Dleading-normal md:leading-[75px] mt-[100px] sm:mt-[150px] md:mt-[223px]">
//             {unit.title}
//           </h1>
...
//             <div className="bg-white rounded-[10px] p-4 sm:p-6 border-2 border-[#20284D] "style={{display: 'flex',  alignItems: 'center', justifyContent: 'space-between'}}>
//               <span className="text-[18px] sm:text-[22px] md:text-[25px] leading-relaxed md:leading-[47px] text-right font-semibold mb-6 sm:mb-8 text-[#20284D]">
//             موثق من وافي
//               </span>
              
     
//           <Image src="/project/image-10.png" alt="Image" width={100} height={100} />
...
//         </div>
//         <div>
//           <h4 className="font-bold text-[#20284D]">اتصل بنا</h4>
...
//         </div>
//         <div>
//           <h4 className="font-bold text-[#20284D]">واتساب</h4>
//           <p className="text-gray-600">0558880867</p>
//         </div>
//       </a>
...
//         </div>
//         <div>
//           <h4 className="font-bold text-[#20284D]">البريد الإلكتروني</h4>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1314px]">
          ...
          <div className="flex flex-col items-start mb-16">
            ...
            >
              ...
              <span className="font-bold text-[#20284D]">{t('viewOnMap')}</span>
            </button>

            <div className="w-full bg-white rounded-[10px] p-6 border-2 border-[#20284D]">
              <h2 className="text-2xl font-bold text-[#20284D] mb-6">{t('contactUs')}</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                <a
                  href="tel:0558880867"
                  className="flex items-center gap-4 p-4 rounded-lg border-2 border-[#20284D] hover:bg-gray-50 transition-colors"
                >
                  ...
                  <div>
                    <h4 className="font-bold text-[#20284D]">{t('contact.callUs')}</h4>
                    <p className="text-gray-600">0558880867</p>
                  </div>
                </a>
                ...
                >
                  <div className="w-12 h-12 rounded-full bg-[#20284D]/10 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="#20284D" viewBox="0 0 24 24" className="w-6 h-6">
                      <path d="M12.031 6.172c-3.181 0-5.767 2.586-5.768 5.766-.001 1.298.38 2.27 1.019 3.287l-.582 2.128 2.182-.573c.978.58 1.911.928 3.145.929 3.178 0 5.767-2.587 5.768-5.766.001-3.187-2.575-5.77-5.764-5.771zm3.392 8.244c-.144.405-.837.774-1.17.824-.299.045-.677.063-1.092-.069-.252-.08-.575-.187-.988-.365-1.739-.751-2.874-2.502-2.961-2.617-.087-.116-.708-.94-.708-1.793s.448-1.273.607-1.446c.159-.173.346-.217.462-.217l.332.006c.106.005.249-.04.39.298.144.347.491 1.2.534 1.287.043.087.072.188.014.304-.058.116-.087.188-.173.289l-.26.304c-.087.086-.177.18-.076.354.101.174.449.741.964 1.201.662.591 1.221.774 1.394.86s.274.072.376-.043c.101-.116.433-.506.549-.68.116-.173.231-.346.231-.686 0-.34-.115-.612-.231-.784-.116-.172-.448-.562-.549-.68-.102-.077-.334-.107-.376-.043z" />
                    </svg>
                  </div>
                    <div>
                    <h4 className="font-bold text-[#20284D]">{t('contact.whatsapp')}</h4>
                    <p className="text-gray-600">0558880867</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <h4 className="font-bold text-[#20284D]">{t('contact.email')}</h4>
                    <p className="text-gray-600">info@tasisalbina.com</p>
                  </div>
                </a>
              </div>
