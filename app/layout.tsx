...
export const metadata: Metadata = {
  ...
  title: {
    default: 'تأسيس البناء | Tasis Al Bina',
    template: '%s | تأسيس البناء'
  },
  description: 'شركة تأسيس البناء للمقاولات والاستشارات الهندسية - خبراء في البناء والتشييد وإدارة المشاريع في المملكة العربية السعودية',
  ...
  openGraph: {
    ...
    title: 'تأسيس البناء | شركة مقاولات وإستشارات هندسية',
  ...
  twitter: {
    ...
    description: 'شركة رائدة في مجال المقاولات والاستشارات الهندسية',
