...
//   return (
//     <footer className="bg-[#20284D] py-16 text-[#AA9554]">
//       <div className="container mx-auto px-4">
//         {/* Newsletter Section */}
//         <div className="text-center mb-16">
//           <h3 className="text-3xl font-bold mb-8">النشرات الالكترونية</h3>
...
//                 className="w-full sm:w-96 bg-transparent text-lg text-[#99999A] px-6 py-4 focus:outline-none"
//               />
//               <button 
//                 type="submit"
...
//               />
//               <h3 className="text-2xl font-bold text-[#20284D] mb-2">شكراً لك!</h3>
//               <p className="text-gray-600">تم الاشتراك في النشرة الإخبارية بنجاح</p>
//             </div>
//           </div>
//         )}
...
//               width={242}
//               height={221}
//               className="mb-8 mx-auto lg:mr-0"
//             />
//             <h4 className="text-2xl font-bold mb-4">شركة تاسيس البناء للتطوير العقاري</h4>
//             <p className="text-lg leading-8 opacity-90">
//               تأسيـــس البنـــاء منتجاتها لعملائها كنتيجة لرحلتها المتواصلة نحو تحقيق التميـــز
//               في مجال السكن الحديث المستدام، وتحقق الاحتياجات والمساهمة في تحقيق حياة متكاملة ومستدامة.
//             </p>
//           </div>

//           {/* Quick Links */}
//           <div className="text-right">
//             <h4 className="text-2xl font-bold mb-8">روابط سريعة</h4>
...
//               <p className="font-bold mb-2">السجل التجاري</p>
...
//               تواصل معنا
//               <span className="absolute bottom-0 right-0 w-full h-0.5 bg-[#AA9554]"></span>
//             </h4>
...
//                       0558880867
//                     </span>
//                     <span className="text-sm text-[#AA9554]/70">الرقم الرئيسي</span>
//                   </div>
//                 </Link>
//               </li>
//               <li>
...
//                     </span>
//                     <span className="text-sm text-[#AA9554]/70">البريد الإلكتروني</span>
//                   </div>
//                 </Link>
//               </li>
...
//                 <div className="text-right">
//                   <span className="text-lg group-hover:text-white transition-colors block">
//                     الريــــاض - حــي الفيحاء
//                   </span>
//                   <span className="text-sm text-[#AA9554]/70">المملكة العربية السعودية</span>
//                 </div>
//               </li>
//             </ul>
//           </div>
...
//           <p>جميع حقوق النشر محفوظة لدى شركة تاسيس البناء للتطوير العقاري</p>
//           <p>صنع بإتقان بواسطة ترميز تك</p>
//         </div>
//       </div>
//     </footer>
//   );
